function [search_window, leaf_nodes, final_nodes, horizon, is_goals] = generate_horizon(init_poses, target_poses, init_node, trim_indices, obstacles, motion_graph, situation_costs, horizon, video)
    ...
    while (~isempty(leaf_nodes) ...
        ...
        [leaf_nodes, final_nodes, search_window, max_id, is_goals] = expand_horizon(leaf_nodes, final_nodes, search_window, cur_node_id, obstacles, motion_graph, ...
