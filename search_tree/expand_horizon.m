function [leaf_nodes, search_tree, max_id, is_goals] = expand_horizon(leaf_nodes, search_tree, next_id, motion_graph, trim_length, target_poses, visited_nodes, max_id, is_goals)
    ...
    for i = 1 : trim_tuple_size
        ...
        [leaf_nodes, search_tree, max_id, is_goals] = update_horizon(cur_node, next_node, leaf_nodes, search_tree, next_id, motion_graph, target_poses, visited_nodes, max_id, is_goals);
