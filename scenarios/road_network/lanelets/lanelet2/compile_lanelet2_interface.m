function compile_lanelet2_interface
    ...
    is_generate_lanelet2_ref_path_loop_indices_mex_compiled = isequal(fileparts(which('generate_lanelet2_ref_path_loop_indices_mex')), folder);
    ...
    if ~is_generate_lanelet2_ref_path_loop_indices_mex_compiled
        fprintf('Compiling generate_lanelet2_ref_path_loop_indices_mex...');
        mex CXXFLAGS = '$CXXFLAGS -std=c++17' ...
            generate_lanelet2_ref_path_loop_indices_mex.cpp ...
            lanelet2_scaled_lab_projector / src / ScaledLab.cpp ...
            '-I/usr/include/eigen3' ...
            '-Ilanelet2_scaled_lab_projector/include' ...
            '-llanelet2_io' ...
        ...
        fprintf('Already compiled: generate_lanelet2_ref_path_loop_indices_mex.\n')
    end
