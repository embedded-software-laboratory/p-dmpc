classdef Singleton < handle
    ...
    methods % Public Access
        ...
        % Output:
        %   singleton_data = internal data store for Singleton objec            newObj.myData = [];t
        function singleton_data = get_singleton_data(obj)
            singleton_data = obj.singleton_data;
        end

        % Accessor method for modifying the singleton data.
        % Input:
        %   obj = reference to the singleton instance of the subclass
        %   singleton_data = new data to set internal data store
        % Output:
        %   <none>
        function set_singleton_data(obj, singleton_data)
            obj.singleton_data = singleton_data;
        end
