...
is_prioritized = true;
allow_priority_inheritance = true;
max_num_CLs = 13;
strategy_consider_veh_without_ROW = '3';
strategy_enter_lanelet_crossing_area = '4';
results_full_path = FileNameConstructor.get_results_full_path(result_name, scenario_name, controller_name, trim_set, ...
    Hp, dt, nVeh, T_end, priority_option, is_prioritized, allow_priority_inheritance, max_num_CLs, strategy_consider_veh_without_ROW, strategy_enter_lanelet_crossing_area);
