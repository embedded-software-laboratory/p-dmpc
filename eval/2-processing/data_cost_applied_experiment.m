function cost = data_cost_applied_experiment(experiment_result)
    ...
    for i_step = 1:n_steps
        ...
        for i_vehicle = 1:n_vehicles
            trajectory_prediction = experiment_result.control_results_info(i_vehicle, i_step).y_predicted(1:2, 1);
