function eval_rhgs(plot_online, is_video_exported)
    % EVAL_RHGS    Script yielding the evaluation results used in the paper
    % Receding Horizon Control Using Graph Search for
    ...
    %% Objective value
    pos_ref = reshape( ...
        results(2).iteration_structs{1}.reference_trajectory_points, ...
        size(results(2).iteration_structs{1}.reference_trajectory_points, 2), ...
        size(results(2).iteration_structs{1}.reference_trajectory_points, 3) ...
    )';
