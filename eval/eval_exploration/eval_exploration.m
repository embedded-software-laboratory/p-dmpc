function eval_exploration(optional)
    ...
    % data export
    mpa = MotionPrimitiveAutomaton(experiment_result(1).options);
    writetable(struct2table(mpa.trims), fullfile(folderpath, 'mpa-trims.dat'));
    adjacency = mpa.transition_matrix_single(:,:,1);
    adjacency_pgf = "{";
    for row = adjacency'
        adjacency_pgf = strcat(adjacency_pgf, "{", sprintf('%d,',row),"},");
    end
    adjacency_pgf = strcat(adjacency_pgf, "}");
    writelines(adjacency_pgf, fullfile(folderpath, 'mpa-adjacency.dat'));
    ...
    writetable(cost_table, fullfile(folderpath, 'prioritization_cost.dat'))
    ...
    writetable(...
        ...
        fullfile(folderpath, 'prioritization_time_med.dat') ...
    );
    ...
    writetable(...
        ...
        fullfile(folderpath, 'prioritization_time_max.dat') ...
    );
    ...
    writetable(...
        ...
        fullfile(folderpath, 'n_levels_med.dat') ...
    );
    ...
    writetable(...
        ...
        fullfile(folderpath, 'n_levels_max.dat') ...
    );
