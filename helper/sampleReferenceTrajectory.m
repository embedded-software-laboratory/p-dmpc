function [reference,curTrajectoryIndex] = sampleReferenceTrajectory(nSamples, referenceTrajectory, vehicle_x,vehicle_y, stepSize, autoUpdatedPath, isPB, lastTrajectoryIndex, is_mixed_traffic)
