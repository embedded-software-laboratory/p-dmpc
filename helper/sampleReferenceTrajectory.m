function [reference,curTrajectoryIndex] = sampleReferenceTrajectory(nSamples, referenceTrajectory, vehicle_x,vehicle_y, stepSize, auto_updated_path, isPB, lastTrajectoryIndex, is_mixed_traffic)
