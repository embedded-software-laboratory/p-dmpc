function [stac, distance_to_collision_i, distance_to_collision_j, collision_type, lanelet_relationship, is_move_side_by_side] = calculate_stac(veh_i, veh_j, scenario, iter)
