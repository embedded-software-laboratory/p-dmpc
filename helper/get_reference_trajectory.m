function [reference, v_ref] = get_reference_trajectory(mpa, total_reference_path, x0, y0, trim, dt_seconds)
    ...
    arguments
        ...
        total_reference_path (:, 2) double % total reference_path from scenario
    ...
    reference = sample_reference_trajectory( ...
        ...
        total_reference_path, ... % total reference path
