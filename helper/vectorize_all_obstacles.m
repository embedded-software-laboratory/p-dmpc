...
% 
%   lanelet_obstacles: 2-by-Hp cell array. Each subcell in the first row
%   corresponds to lanelet, such as lanelet boundaries and
...
% 
    ...
    lanelet_crossing_areas_tmp = cellfun(@(c)[c,c(:,1),[nan;nan]],scenario.lanelet_crossing_areas,'UniformOutput',false); 
