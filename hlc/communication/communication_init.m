function communication_init(hlc)
    ...
    if ~hlc.scenario.options.is_manual_control
        ...
        for veh_index = other_vehicles
            ...
            read_message(hlc.scenario.vehicles(hlc.indices_in_vehicle_list(1)).communicate.traffic, hlc.ros_subscribers.traffic{veh_index}, hlc.k, 40.0);
            read_message(hlc.scenario.vehicles(hlc.indices_in_vehicle_list(1)).communicate.predictions, hlc.ros_subscribers.predictions{veh_index}, hlc.k, 40.0);
        end
