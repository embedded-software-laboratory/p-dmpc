            ...
            while (~obj.got_stop)
                ...
                if obj.scenario.options.compute_in_parallel
                    ...
                    if obj.scenario.options.fallback_type == FallbackType.local_fallback
                        ...
                        for veh_id = other_vehicles
                            latest_msg = read_message(obj.scenario.vehicles(obj.plant.indices_in_vehicle_list(1)).communicate.predictions, obj.ros_subscribers.predictions{veh_id}, obj.k);
                ...
                if obj.scenario.options.fallback_type == FallbackType.no_fallback
                    ...
                    if ~isempty(obj.info.vehs_fallback)
                        ...
                        obj.info = pb_controller_fallback(obj.iter, obj.info, obj.info_old, obj.scenario, obj.plant.veh_ids, obj.plant.indices_in_vehicle_list);
