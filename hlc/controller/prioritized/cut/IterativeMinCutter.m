classdef IterativeMinCutter < Cutter

    methods

        function belonging_vector = min_cut(~, M, must_not_in_same_subset, must_in_same_subset)
            ...
            for i = 1:length(must_in_same_subset)
                ...
                if length(must_in_same_subset_i) >= 2
                    ...
                    for j = length(must_in_same_subset_i):-1:2
                        ...
                        [M_reduced, vertex_indices_reduced] = IterativeMinCutter.merge_two_vertices(M_reduced, merging_point_local, vertes_to_be_merged_local, vertex_indices_reduced);
                    end
            ...
            while length(vertex_indices_reduced) > 1
                ...
                [vertex_s_local, vertex_t_local] = IterativeMinCutter.minimum_cut_phase(M_reduced);
                ...
                [M_reduced, vertex_indices_reduced] = IterativeMinCutter.merge_two_vertices(M_reduced, vertex_s_local, vertex_t_local, vertex_indices_reduced);
