classdef (Abstract) HighLevelController < handle
    ...
    methods (Access = protected)
        ...
        function init(obj)
            ...
            obj.result = get_result_struct(obj.options, obj.scenario_adapter.scenario, obj.plant.controlled_vehicle_ids);
    ...
    methods (Access = private)
        ...
        function save_results(obj)
            ...
            obj.result.scenario = obj.scenario_adapter.scenario;
