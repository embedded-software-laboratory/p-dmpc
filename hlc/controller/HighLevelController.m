    ...
    methods (Access = protected)
        ...
        function init(obj)
            ...
            for vehicle_idx = obj.plant.indices_in_vehicle_list
                ...
                initial_pose = [ ...
                                    obj.scenario_adapter.scenario.vehicles(vehicle_idx).x_start, ...
                                    obj.scenario_adapter.scenario.vehicles(vehicle_idx).y_start, ...
                                    obj.scenario_adapter.scenario.vehicles(vehicle_idx).yaw_start ...
                                ];
        ...
        function update_hdv_traffic_info(obj, states_measured, cav_measurements, hdv_measurements)
            ...
            for iHdv = 1:obj.options.manual_control_config.amount
                ...
                reachable_sets = obj.scenario_adapter.manual_vehicles(iHdv).compute_reachable_lane( ...
                    [hdv_measurements(iHdv).x, hdv_measurements(iHdv).y, hdv_measurements(iHdv).yaw, hdv_measurements(iHdv).speed], ...
                    lanelet_id_hdv ...
                );
                ...
                for iVeh = obj.plant.indices_in_vehicle_list
                    ...
                    obj.iter.hdv_adjacency(iVeh, iHdv) = ~is_hdv_behind( ...
                        lanelet_id_cav, ...
                        [cav_measurements(iHdv).x, cav_measurements(iHdv).y, cav_measurements(iHdv).yaw, cav_measurements(iHdv).speed], ...
                        lanelet_id_hdv, ...
                        [hdv_measurements(iHdv).x, hdv_measurements(iHdv).y, hdv_measurements(iHdv).yaw, hdv_measurements(iHdv).speed], ...
                        obj.scenario_adapter.scenario.lanelets, ...
