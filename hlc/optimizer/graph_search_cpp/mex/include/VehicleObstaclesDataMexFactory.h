...
namespace GraphBasedPlanning {
	VehicleObstaclesData make_vehicle_obstacles_data(matlab::data::ObjectArray const& iter, matlab::data::CellArray const& vehicle_obstacles_cell_array, std::shared_ptr<ConfigData const> const& config, std::shared_ptr<matlab::engine::MATLABEngine>& _matlab) {
