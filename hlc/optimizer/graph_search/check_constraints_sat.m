function collision = check_constraints_sat( ...
        iter, ...
        index, ...
        shapes, ...
    ...
    % check_constraints_sat    Determine whether position has a collision.
    ...
    if ~isempty(iter.predicted_lanelet_boundary(index, :))
        ...
        if intersect_lanelet_boundary(shapes_for_boundary_check{index}, iter.predicted_lanelet_boundary(index, :))
            collision = true;
            return;
        end
