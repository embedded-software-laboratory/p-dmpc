...
for (( i=0; i<$N_VEH; i++ )); do
    sshpass -e rsync -r --exclude 'plant/matlab_msg_gen' --exclude 'results' ./graph_based_planning guest@192.168.1.2${WORKING_NUCS[$i]}:/home/guest/dev/software/high_level_controller/
