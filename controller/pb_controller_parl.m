...
%                 graphs_visualization(belonging_vector, coupling_weights, 'ShowWeights', true)
        ...
        for vehicle_k = vehs_level_i
            ...
            [predicted_lanelets,~,~] = get_predicted_lanelets(scenario.vehicles(vehicle_k), trim_current, x0, y0, scenario.mpa, scenario.dt, scenario.options.isParl, scenario.name);
