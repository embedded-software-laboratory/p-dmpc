function exportFrame(result,frameExportSetup)
...
arguments
    result struct;
    frameExportSetup.iStep {mustBeInteger} = 1;
    frameExportSetup.frame_name string = 'frame.png';
end
...
frame_idx = 1;
plotting_info = PlottingInfo(scenario.options.veh_ids,result,frameExportSetup.iStep,frame_idx,scenario.options.options_plot_online);
...
filepath = fullfile(results_folder_path, frameExportSetup.frame_name); % full path of the fig
