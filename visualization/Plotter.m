classdef (Abstract) Plotter < handle
    ...
    methods
        ...
        function plot(obj, plotting_info)
            ...
            level_of_vehicle = Prioritizer.level_of_vehicle(plotting_info.directed_coupling);
            ...
            for v = obj.veh_indices
                line( ...
                    ...
                    'Color', obj.priority_colormap(level_of_vehicle(v), :), ...
                    'LineStyle', 'none', ...
                    'Marker', 'o', ...
                    'MarkerFaceColor', obj.priority_colormap(level_of_vehicle(v), :), ...
                    'MarkerSize', 3, ...
                    'LineWidth', 1, ...
                    Tag = "temporary" ...
                );
            ...
            for v = obj.veh_indices
                ...
                patch( ...
                    vehiclePolygon(1, :) ...
                    , vehiclePolygon(2, :) ...
                    , obj.priority_colormap(level_of_vehicle(v), :) ...
                    , 'LineWidth', 1 ...
                    , Tag = "temporary" ...
                );
