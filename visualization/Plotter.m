    ...
    methods
        ...
        function plot(obj, plotting_info)
            ...
            for i_vehicle = obj.vehicle_indices
                ...
                line( ...
                    plotting_info.trajectory_predictions{i_vehicle}([1:obj.options.tick_per_step + 1:end, end], 1), ...
                    plotting_info.trajectory_predictions{i_vehicle}([1:obj.options.tick_per_step + 1:end, end], 2), ...
                    'Color', obj.priority_colormap(vehicle_to_computation_level(i_vehicle), :), ...
                    'LineStyle', 'none', ...
                    'Marker', '+', ...
                    'MarkerFaceColor', obj.priority_colormap(vehicle_to_computation_level(i_vehicle), :), ...
                ...
                line( ...
                    plotting_info.trajectory_predictions{i_vehicle}(:, 1), ...
                    plotting_info.trajectory_predictions{i_vehicle}(:, 2), ...
                    'Color', obj.priority_colormap(vehicle_to_computation_level(i_vehicle), :), ...
                    'LineWidth', 1, ...
                    Tag = "temporary" ...
                );
                ...
                pos_step = plotting_info.trajectory_predictions{i_vehicle};
            ...
            if obj.plot_options.plot_coupling
                ...
                weighted_coupling_reduced = double(plotting_info.directed_coupling_reduced) .* plotting_info.weighted_coupling;
