...
function [list] = list_scenario(ui)
    is_unified_lab_interface_selected = get_environment_selection(ui, true) == Environment.UnifiedTestbedInterface;

    if is_unified_lab_interface_selected % Only allow lanelet2 maps here
        list = { ...
                    ScenarioType.lanelet2, 'Lanelet2'; ...
                    ScenarioType.lab_default, 'Lab Default (UTI only)'; ...
                    ScenarioType.lanelet2_ids3c_circle, 'Lanelet2 IDS3C Circle'; ...
                    ScenarioType.lanelet2_ids3c_circle_in_cpm, 'Lanelet2 IDS3C Circle in CPM' ...
                };
    else
        list = { ...
