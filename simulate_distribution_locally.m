function [result,scenario] = simulate_distribution_locally(scenario)
    ...
    while (~got_stop)
        ...
        for iVeh = 1:scenario.options.amount 
            if scenario.options.visualize_reachable_set && ((scenario.vehicle_ids(iVeh) == scenario.manual_vehicle_id && scenario.options.firstManualVehicleMode == 2) ...
